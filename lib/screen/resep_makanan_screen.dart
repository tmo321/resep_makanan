...
import 'package:resep_makanan/cubit/resep_makanan_cubit.dart';
import 'package:resep_makanan/screen/detail_resep_makanan_screen.dart';
...
class _ResepMakananScreenState extends State<ResepMakananScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Tomy Himawan - 191011450380'),
      ),
